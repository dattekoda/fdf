...
void	render_square(t_img *img, t_square point, int color)
{
	...
	render_line(img, (t_line){point.s_x, point.s_y, point.s_x, point.g_y}, (t_color){0xffffff, 0xffffff});
	render_line(img, (t_line){point.s_x, point.s_y, point.g_x, point.s_y}, (t_color){0xffffff, 0xffffff});
	render_line(img, (t_line){point.s_x, point.g_y, point.g_x, point.g_y}, (t_color){0xffffff, 0xffffff});
